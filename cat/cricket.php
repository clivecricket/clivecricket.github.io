<?php  
 ...
 {  
      ...
      {  
           if(file_exists('cricket.json'))  
           {  
                $current_data = file_get_contents('cricket.json');  
                ...
                if(file_put_contents('cricket.json', $final_data))  
                {  
 ...
 <html>  
      ...
      <body>  
           ...
           <div class="container" style="width:500px;">  
                <h3 align="center" style="background:green;border-radius:4px;padding:4px;color:white;">api.commondp.com - cricket</h3><br />                 
                <form method="post">  
                     <?php   
                     if(isset($error))  
                     {  
